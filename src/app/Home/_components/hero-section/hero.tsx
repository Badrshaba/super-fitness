...
export default function HeroSection() {
  ...
  return (
    <>
      {/* ===== Hero Section ===== */}
      <section className="flex flex-wrap-reverse justify-center gap-5 font-rubik mt-[110px] md:mt-[200px] mx-4 md:mx-20">
        {/* ===== Left Content Section ===== */}
        <div className="left pt-0 w-full md:w-1/2  text-charcoal dark:text-cloudy md:pt-16">
          {/* --- Heading --- */}
          ...
          {/* --- Counter Boxes --- */}
          <div className="counter-box grid grid-cols-2 md:grid-cols-3 gap-3  mt-16">
            {/* --- Counter Items --- */}
            <div className="counter-item flex flex-col items-center ">
              <AnimatedNumber target={1500} />
          ...
          <div className="cta mt-16 mb-4 flex flex-wrap gap-5 md:gap-10 justify-center items-center md:justify-normal">
